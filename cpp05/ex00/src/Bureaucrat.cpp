...
/*   Updated: 2025/11/17 16:44:25 by madias-m         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (n > 150)
		throw GradeTooLowException("Error: Grade cannot be great than 150");
	if (n < 1)
		throw GradeTooHighException("Error: Grade cannot be lower than 1");
	this->grade = n;
}
